...
go get -u -v golang.org/x/tools/cmd/gorename github.com/alecthomas/gometalinter github.com/kisielk/errcheck github.com/nsf/gocode honnef.co/go/implements golang.org/x/tools/cmd/goimports github.com/rogpeppe/godef
